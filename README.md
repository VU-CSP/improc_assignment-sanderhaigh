...
A1) Put your answer here.  Max intensity = 255 intensity units 

Q2) What are the dimensions of the [Phase contrast](image_files/PhaseContrast.tif) file?  
A2) Put your answer here in the form of (X, Y, BitDepth).   Answer = (314,226, 8-bit depth)

Q3) Which image has greater dynamic range of pixel intensities? Phase or DiffInt?  
A3) Put your answer here.  Answer = Differential Interference image 
...
A4) Put your answer here.  Answer = 1417 particles detected 
